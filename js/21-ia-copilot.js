...
var IA_PROVIDERS={
  ...
  github:{label:'GitHub Models (gratuit)',model:'azure-openai/gpt-5',placeholder:'github_pat_...',aide:'Créez un token gratuit sur github.com/settings/personal-access-tokens/new avec la permission "Models: Read-only" (aucune carte bancaire).'},
...
async function iaAppelerIA(question, contexte){
  ...
  if(provider==='groq'){
    ...
    console.log('[Chat IA] Modèle envoyé à GitHub Models :', IA_PROVIDERS.github.model);
