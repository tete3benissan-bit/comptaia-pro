...
const CACHE_NAME = 'gest-africa-shell-v4';
...
const PRECACHE_URLS = [
  ...
  'js/00-supabase-client.js','js/00b-pays-secteur.js','js/01-core.js','js/02-immo-bilan-pdf-ia.js','js/03-v10-panes-inject.js',
